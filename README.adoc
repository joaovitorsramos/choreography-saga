...
. First, execute all the steps in <<Create Stock Items>>  and <<Create Orders>>. Then fill the stock with 100 items of aspirin at the "1010" branch 
...
. Now check the stock for the "123_aspirin" SKU
...
. To check the stock for the SKU "123_aspirin" at the "1212" branch
...
. Finally, check for all SKUs in stock at the "1212" and "1010" branches 
